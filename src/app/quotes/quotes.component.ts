...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[] = [
    new Quote (1,'Tommy','Experience','What Does Not Kill you makes you Stronger.','gregory issacs', new Date(2019,7,12),0,0),
    new Quote (2,'Mary Jane','mindsate…','Madness is like gravity all it needs is a little Push.','The joker',new Date(2019,7,14),0,0),
